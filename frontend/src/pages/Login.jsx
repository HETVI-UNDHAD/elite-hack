      ...
      <div className="relative z-10 bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full border-2 border-emerald-100">
        <div className="text-center mb-8">
          ...
          <h2 className="text-4xl font-bold text-gray-800 mb-2">
            Welcome <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600">Back</span>
          </h2>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link to="/register" className="font-bold text-emerald-600 hover:text-teal-600 transition-colors">
              Register here →
            </Link>
          </p>
        </div>
